        ...
        <div className="mx-auto max-w-5xl">
          ...
          <div className="flex flex-col items-center text-center">
            <div className="inline-flex h-9 items-center gap-2 rounded-full border border-sky-500/20 bg-sky-500/10 px-4 text-sm text-sky-400">
              ...
              Safe & Confidential Incident Reporting
            </div>
          ...
          {/* Features Grid */}
          <div className="mt-40 mb-20 grid gap-6 sm:grid-cols-3">
            {[
              {
              ...
              },
              {
                ...
                description:
                  "Two-way anonymous channel with emergency responders",
                icon: (
                  <svg
                    className="h-6 w-6 text-sky-400"
                    fill="none"
          ...
          <div className="mt-40 mb-20 flex justify-center">
            <div className="inline-flex items-center gap-3 rounded-full bg-zinc-900 px-5 py-2 text-sm text-zinc-400">
              ...
              Trusted by Emergency Responders Nationwide
            </div>
          </div>
        </div>
      </main>
